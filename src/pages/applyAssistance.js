...
class applyAssistance extends Component {
  constructor(props) {
    super(props);
  ...
  book() {
    if (!this.ValidateEmail(this.state.mail)) {
      ...
      form.append('cv', this.state.file);
      this.props.applyAssistant(form);
    }
  }
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <p class="section-title">Apply as an Assistant</p>
              </div>
            </div>
            <div class="row">
...
export default withRouter(connect(mapStateToProps, actions)(applyAssistance));
